...
\abstractauthor[Bernd Hentschel / Dave Pugmire]{%
...
Conduit~\cite{Conduit}, ADIOS~\cite{Lofstead08}, and SENSEI~\cite{Ayachit16} broadly fall into the first category, while the latter comprises, e.g., LibSim~\cite{Whitlock11} and Catalyst~\cite{Fabian11}.
